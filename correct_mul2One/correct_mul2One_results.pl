...
my $in0 = $ARGV[0]; ##- merege_error_annotations
my $in1 = $ARGV[1]; ##- first.pep.fa.TandemGeneArray
my $in2 = $ARGV[2]; ##- genewise.gff3
my $in3 = $ARGV[3]; ##- final.evm.gff3.HQ
...
sub process {
    ...
    my $finalGff3 = "final.insert.gff3";
    &insert($genewise, $cleanGenes, \%genewise2gff3, \%gene2gff3, $finalGff3);    
