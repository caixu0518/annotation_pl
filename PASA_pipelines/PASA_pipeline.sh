...
blastp=/data/caix_Data/src/ncbi-blast-2.2.30+/bin/blastp
...
${blastp}  -evalue  1e-10   -query  pasa.filter.pep  -out  pasa.filter.blast  -db  ${homolog_protein}   -max_target_seqs  10  -num_threads  15   -outfmt  "7  $BLAST_F4"
