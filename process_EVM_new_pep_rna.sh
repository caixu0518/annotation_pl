...
genome=$1
protein="genewise.all.gff3"
transcript="pasa.train.gff"
gene_predictions="genewise.gff3"
threads=50
...
$EVM/EvmUtils/write_EVM_commands.pl    --genome  ${genome}  --gene_predictions  gene_predictions.gff  --protein_alignments  protein_alignments.gff  --transcript_alignments  transcript_alignments.gff  --weights  `pwd`/weights2.txt  --output_file_name  evm.out  --partitions  partitions_list.out  >  commands.lis
